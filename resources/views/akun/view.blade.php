            ...
            <div class="card-body">
                ...
                <form action="{{ route('save_account') }}" method="POST">
                    ...
                    <div class="form-group" id="header_account">
                        ...
                        <select class="js-example-basic-single @error('header_account')
                            is-invalid
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-rounded" id="saldo_akun" name="balance" placeholder="Masukan saldo" value="{{ old('balance', 0) }}">
                    </div>
