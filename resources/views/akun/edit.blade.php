    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form action="{{ route('update_account', $akun->no_account) }}"
                    method="POST">
                    @method('put')
                    @csrf
                    <div class="form-check">
                        <label class="form-check-label"
                            ...
                            <input type="checkbox"
                                ...
                                value="1"
                                @if ($akun->is_header_account) checked
                                @else @endif>
                            Header Akun
                        </label>
                    </div>
                        ...
                        <select class="js-example-basic-single"
                            ...
                            @forelse ($akun_headers as $akun_header)
                                @if (old('header_account', $akun_header->no_account) == $akun->header_account)
                                    <option value="{{ $akun_header->no_account }}"
                                        selected>{{ $akun_header->name_account }}
                        ...
                        <select name="type_account"
                            ...
                            @for ($i = 1; $i <= 3; $i++)
                                @if (old('type_account', $akun->type_account) == $i)
                                    <option value="{{ $akun->type_account }}"
                                        selected>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"
                            ...
                            value="{{ old('balance', $akun->balance) }}">
                    </div>
