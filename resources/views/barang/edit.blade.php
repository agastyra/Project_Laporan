<x-layout.app>
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <h6 class="mb-0 text-uppercase">Edit Barang</h6>
            <hr />
                ...
                <div class="card-body" style="background: black; color: white;">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-white">{{$barang->name_barang}}</h5>
                        </div>
                        <hr />
                        ...
                        <form action="{{route('update_barang', $barang->no_barang)}}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="no_barang" value="{{old('no_barang', $barang->no_barang)}}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name_barang"
                                        value="{{old('name_barang', $barang->name_barang)}}" class="form-control"
                                        id="inputPhoneNo2" placeholder="Masukan Nama barang" style="color: white;">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="stok" value="{{old('stok', $barang->stok)}}"
                                        class="form-control" id="inputEmailAddress2" placeholder="Masukan Jumlah Barang"
                                        style="color: white;">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="harga_beli"
                                        value="{{old('harga_beli', $barang->harga_beli)}}" class="form-control"
                                        id="inputChoosePassword2" placeholder="Masukan Harga Beli"
                                        style="color: white;">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="harga_jual"
                                        value="{{old('harga_jual', $barang->harga_jual)}}" class="form-control"
                                        id="inputConfirmPassword2" placeholder="Masukan Harga Jual"
                                        style="color: white;">
                                </div>
                            </div>
